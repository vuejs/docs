...
<template>
  <div class="banner" v-if="open">
    <a id="vt-top" :href="`${banner.link}?utm_source=vuejs&utm_content=top_banner`" target="_blank"
      :class="banner.assets">
      <div class="vt-background-wrapper">
        <div class="vt-logo">
          <svg width="64" height="50" viewBox="0 0 200 141" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              ...
              fill="white" />
            <path d="M26.3378 78.7056H34.4203V99.5618H41.3054V78.7056H49.4307V72.6591H26.3378V78.7056Z" fill="white" />
            <path
