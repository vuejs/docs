...
:::tip
Note the click handler uses `store.increment()` with the parenthesis - this is unnecessary to call the method with the proper `this` context since it's not a component method.
:::
