...
:::tip
У багатьох прикладах Composition API у посібнику використовуватиметься синтаксис `<script setup>`, для якого потрібні інструменти для збірки. Якщо ви збираєтеся використовувати Composition API без кроку збірки, отримайте довідку по використанню [параметра `setup()`](/api/composition-api-setup).
:::
