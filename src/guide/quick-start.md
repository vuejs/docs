...
Make sure you have an up-to-date version of [Node.js](https://nodejs.org/) installed and with your current working directory as the one where you intend to create a project. Run the following command in your command line (without the `>` sign):
