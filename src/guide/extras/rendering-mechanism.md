...
1. Templates are closer to actual HTML. This makes it easier to reuse existing HTML snippets, apply best practices, style with CSS, and for designers to understand and modify.
