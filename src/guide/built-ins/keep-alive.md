...
By default, an active component instance will be unmounted when switched away from it. This will cause any changed state it holds to be lost. When this component is displayed again, a new instance will be created with only the initial state.
