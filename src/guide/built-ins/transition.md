...
<div class="demo">
  ...
  <Transition name="slide-fade">
    <p style="margin-top:20px" v-if="show2">hello</p>
  </Transition>
</div>
...
<div class="demo">
  ...
  <Transition name="bounce">
    <p v-if="show3" style="margin-top: 20px; text-align: center;">
      Hello here is some bouncy text!
    </p>
  </Transition>
</div>
...
<div class="demo">
  ...
  <Transition duration="550" name="nested">
    <div v-if="show4" class="transition-demo-outer">
...
Check out this <span class="composition-api">[full example of JavaScript transition](https://sfc.vuejs.org/#)</span><span class="options-api">[full example of JavaScript transition](https://sfc.vuejs.org/#)</span> using the [GreenSock library](https://greensock.com/). You can, of course, use any other animation library you want, for example [Anime.js](https://animejs.com/) or [Motion One](https://motion.dev/).
