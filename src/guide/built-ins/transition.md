...
### Зауваження продуктивності {#performance-considerations}
...
При використанні лишу JavaScript переходів, як правило, гарною ідеєю буде додати властивість `:css="false"`. Це явно вказує Vue пропустити автоматичне виявлення переходів CSS. Окрім трохи більшої продуктивності, це також запобігає випадковому втручанню правил CSS у перехід:
...
Реквизити `<Transition>` такі як `name` також можуть бути динамічними! Це дозволяє нам динамічно застосовувати різні переходи на основі зміни стану:
