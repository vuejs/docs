...
Transitioning between components is even simpler - we don't even need the `key` attribute. Instead, we wrap a [dynamic component](/guide/essentials/component-basics.html#dynamic-components):
