...
## Differenze rispetto a `<Transition>` {#differences-from-transition}
...
- Le [Modalità di Transizione](./transition#transition-modes) non sono disponibili, dato che non stiamo più alternando elementi mutualmente esclusivi.
...
## Transizioni di Spostamento {#move-transitions}
...
- [Referenza API `<TransitionGroup>`](/api/built-in-components#transitiongroup)
