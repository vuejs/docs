...
Кожне прив'язування може містити лише **один вираз**. Вираз — це фрагмент коду, який може обчислити значення. Просто перевірте чи можна ним користуватись після `return`.
