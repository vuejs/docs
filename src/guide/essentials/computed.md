...
Вирази, вбудовані в шаблон є досить зручними, але їх слід використовувати лише для простих дій. Додавання дуже багато логіки до шаблонів може їх роздути та ускладнити подальше обслуговування. Наприклад, у нас є об'єкт з вкладеним масивом:
...
Як бачите, шаблон стає дещо захаращеним. Якщо на секунду поглянути на нього, то буде зрозуміло, що він виконує певне обчислення, яке залежить від `author.books`. Більше того, ми напевне не хочемо повторювати самих себе, якщо б нам потрібно було скористатись цим обчисленням в шаблоні більше, ніж один раз.
