...
অলস লোডিং এমন বৈশিষ্ট্যগুলিতে সবচেয়ে ভাল ব্যবহার করা হয় যেগুলি প্রাথমিক পৃষ্ঠা লোডের পরে অবিলম্বে প্রয়োজন হয় না। Vue অ্যাপ্লিকেশনগুলিতে, এটি উপাদান গাছের জন্য বিভক্ত অংশ তৈরি করতে Vue এর [Async Component](/guide/components/async) বৈশিষ্ট্যের সাথে একত্রে ব্যবহার করা যেতে পারে:
