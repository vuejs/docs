...
Щоб повністю захистити своїх користувачів від clickjacking, ми рекомендуємо надавати повний контроль над CSS лише всередині iframe ізольованого програмного середовища. Крім того, якщо користувачеві надається контроль за допомогою прив'язки стилю, ми рекомендуємо використовувати його [об'єктний синтаксис](/guide/essentials/class-and-style#binding-to-objects-1) і дозволяти користувачеві вказувати лише значення для конкретних властивостей, які можна змінювати безпечно, наприклад:
...
Під час використання SSR існують додаткові проблеми з безпекою, тому обов'язково дотримуйтесь найкращих практик, викладених у [нашій SSR документації](/guide/scaling-up/ssr#server-side-rendering-ssr), щоб уникнути вразливостей.
