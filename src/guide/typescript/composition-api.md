...
Щоб отримати правильний інтерфейс DOM, ви можете переглянути такі сторінки, як [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#technical_summary).
