...
- **Usage:**
  ...
  Mounts a root component of the application instance on the provided DOM element. If application has a `template` option, the `innerHTML` of the DOM element will be replaced with the rendered template.
