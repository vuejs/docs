...
- **Приклад**
  ...
  Зауважте, що якщо ви використовуєте стрілкову функцію з властивістю `data`, `this` не буде екземпляром компонента, але ви все одно можете отримати доступ до екземпляра як першого аргументу функції:
...
- **Подробиці**
  ...
  Зауважте, що якщо ви використовуєте стрілкову функцію з обчислюваною властивістю, `this` не вказуватиме на екземпляр компонента, але ви все одно можете отримати доступ до екземпляра як першого аргументу функції:
...
- **Подробиці**
  ...
  Уникайте використання стрілкових функцій під час оголошення методів, оскільки вони не матимуть доступу до екземпляра компонента через `this`.
...
- **Подробиці**
  ...
  Уникайте використання стрілкових функцій під час оголошення зворотних викликів спостереження, оскільки вони не матимуть доступу до екземпляра компонента через `this`.
