# Часті запитання та відповіді {#frequently-asked-questions}
...
Vue 2.7, який було відправлено у липні 2022 року, є останнім незначним випуском у діапазоні версій Vue 2. Vue 2 перейшов у режим технічного обслуговування: він більше не постачатиме нові функції, але продовжуватиме отримувати критичні виправлення помилок та оновлення безпеки протягом 18 місяців, починаючи з дати випуску 2.7. Це означає, що **Vue 2 досягне кінця життя 31 грудня 2023 року**.
